...
class LeituraHTML{
    public static void main(String args[]){
        ...
        int casos = 0;
        while(!site.equals("FIM")){

            String texto = ExemploURL.getHtml(MyIO.readLine());//convertendo o html em string
            //declarando os contadores:
            ...
            //loop que percorre a string do html do site
            for(int k = 0; k < texto.length(); k++){
                //switch que conta o número dos caracteres desejados
                ...
                switch(c){
                    ...
                    case '<':
                        int j = k + 1; 
                        if(texto.charAt(j) == 'b' && texto.charAt(j + 1) == 'r' && texto.charAt(j + 2) == '>'){
                            br++;
                        }
                        else if(texto.charAt(j) == 't' && texto.charAt(j + 1) == 'a' && texto.charAt(j + 2) == 'b' && texto.charAt(j + 3) =='l' && texto.charAt(j + 4) == 'e' && texto.charAt(j + 5) == '>'){
                            table++;
                        }
            ...
            MyIO.print("consoante(" + consoante + ") <br>(" + br + ") <table>(" + table + ") " + site);
            MyIO.println("");
